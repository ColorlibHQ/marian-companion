...
class Marian_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Marian ] Social Links', 'marian-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'marian-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'marian-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'marian-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'marian-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'marian-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'marian-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'marian-companion'); ?></label>
...
} // Class marian_social_links ends here


// Register and load the widget
function marian_social_links_widget_load() {
	register_widget( 'Marian_social_links' );
}
add_action( 'widgets_init', 'marian_social_links_widget_load' );